...
de_install_cmd() {
    ...
    case "$family:$style" in
        apt:xfce)     echo "apt-get update -qq && apt-get install -y -qq xfce4 dbus-x11" ;;
        apt:lxqt)     echo "apt-get update -qq && apt-get install -y -qq lxqt dbus-x11" ;;
        apt:i3)       echo "apt-get update -qq && apt-get install -y -qq i3 dmenu dbus-x11 xterm" ;;
        ...
        dnf:xfce)     echo "dnf install -y -q xfce4-session xfdesktop xfce4-panel xfce4-terminal dbus-x11" ;;
        dnf:lxqt)     echo "dnf install -y -q @lxqt-desktop-environment dbus-x11" ;;
        dnf:i3)       echo "dnf install -y -q i3 dmenu dbus-x11 xterm" ;;
